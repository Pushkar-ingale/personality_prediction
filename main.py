...
def prediction_result(top, aplcnt_name, cv_path, personality_values):
    ...
    # Parsing Resume using pdfplumber
    ...
    Label(result, text=str("Resume Text: " + resume_text), foreground='black', bg='white', anchor='w').pack(fill=BOTH)
...
def perdict_person():
    ...
    l5 = Label(top, text="Enjoy New Experience or thing", foreground='white', bg='black').place(x=70, y=250)
    l6 = Label(top, text="How Offen You Feel Negativity", foreground='white', bg='black').place(x=70, y=280)
    l7 = Label(top, text="Wishing to do one's work well and thoroughly", foreground='white', bg='black').place(x=70, y=310)
    l8 = Label(top, text="How much would you like work with your peers", foreground='white', bg='black').place(x=70, y=340)
    l9 = Label(top, text="How outgoing and social interaction you like", foreground='white', bg='black').place(x=70, y=370)
